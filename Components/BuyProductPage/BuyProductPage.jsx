...
const thumbImagesBuyProductPage = [
    './beyvoraShopage1.png',
    './PorductPageBuy10.jpg',
];
        ...
        <div className="pageWrapperBuyProductPage">
            <div className="topSectionBuyProductPage">
                <div className="gallerySectionBuyProductPage">
                    ...
                    <div className="thumbGridBuyProductPage">
                        {thumbImagesBuyProductPage.map((imgSrc, index) => (
                            <div className="thumbItemBuyProductPage" key={index}>
                                <img
                                    src={imgSrc}
                                    alt={`Batman wall art view ${index + 1}`}
                                    className="thumbImageBuyProductPage"
                                />
                            </div>
                        ))}
                    </div>
